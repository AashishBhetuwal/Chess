...
import aashish.board.moves.MovesOfPrincess;
...
public class PiecePrincess extends MainPiece {

   
    public PiecePrincess(boolean colorChoice) {
        super(colorChoice);
    }

    public void learnMainMovesFrom(AashishSquare referenceAashishSquare, AashishGame referenceAashishGame) {
        referenceMainMoves = new MovesOfPrincess(referenceAashishSquare, referenceAashishGame, this.isBlack);
    }
}
